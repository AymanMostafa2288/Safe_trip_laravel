...
@section('script_in_page_custom')
    <script>
		...
		if($("#map_leatflate").length > 0){
			...
			var map = L.map('map_leatflate').setView([26.549999, 31.700001], 8);
			var marker ='';
		...
		<div class="page-content">
			...
			<div class="page-head">
				...
				<div class="page-title">
					<h1>
                        {{ appendToLanguage(getDashboardCurrantLanguage(),'globals',$config['main_title']) }}
                    </h1>
				</div>
				<!-- END PAGE TITLE -->
			</div>
			...
			<ul class="page-breadcrumb breadcrumb">
				...
				<li>
                    <a href="{{ route($breadcrumb['route']) }}{{ $sting_query }}">
