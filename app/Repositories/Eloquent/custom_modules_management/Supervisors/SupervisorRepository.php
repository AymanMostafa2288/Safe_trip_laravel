<?php
namespace App\Repositories\Eloquent\custom_modules_management\Supervisors;
use App\Enum\Custom\WorkerTypeEnum;
use App\Models\CustomModels\Driver;
use App\Models\CustomModels\Worker;
...
use App\Models\CustomModels\Supervisor;
use Exception;
use File;
use DB;
...
class SupervisorRepository implements SupervisorInterface {
    ...
    public function data($request, $id = "*", $field_name = ""){
        ...
        if ($id == "*") {
            ...
            $request['where'] = [
                ['type' => WorkerTypeEnum::SUPERVISOR]
            ];
