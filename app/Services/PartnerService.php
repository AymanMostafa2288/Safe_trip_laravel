...
use App\Repositories\Interfaces\custom_modules_management\Partners\PartnerInterface;

 class PartnerService{

    public $model;
    public $interface;
    public function __construct(Blog $model,PartnerInterface $interface)
    {
        $this->model = $model;
    ...
    public function index($filters,$page = 1,$row_in_page=9){
        ...
        $body = app(PartnerInterface::class)->data($request);
